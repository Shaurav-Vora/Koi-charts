...
const controls: { phrase: string; command: GraphCommand; exactOnly?: true }[] = [
 ...
 {phrase:"restart test",command:{kind:"playback",action:"restart",choice:null}},
 ...["repeat","repeat step"].map(phrase=>({phrase,command:{kind:"playback",action:"repeat",choice:null} as GraphCommand})),
 {phrase:"next issue",command:{kind:"audit",action:"next"}},
 {phrase:"previous issue",command:{kind:"audit",action:"previous"}},
 {phrase:"repeat issue",command:{kind:"audit",action:"repeat"}},
 {phrase:"close check",command:{kind:"audit",action:"close"}},
 ...
 ...["validate chart","validate the chart","check chart","check the chart"].map(phrase=>({phrase,command:{kind:"audit",action:"open"} as GraphCommand})),
